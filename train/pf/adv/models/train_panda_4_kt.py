...
top = make_coll('/fastscratch/snarayan/pandaarrays/v1_kt//PARTITION/Top_*_CATEGORY.npy')
qcd = make_coll('/fastscratch/snarayan/pandaarrays/v1_kt//PARTITION/QCD_*_CATEGORY.npy')
