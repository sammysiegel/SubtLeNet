...
opts = {'learn_mass':LEARNMASS, 
        ...
        'learn_rho':LEARNRHO,
        'normalize':False}
classifier_train_gen = obj.generatePF(data, partition='train', batch=501, **opts)
classifier_validation_gen = obj.generatePF(data, partition='validate', batch=1001, **opts)
...
if ADV % 2 == 0:
    ...
    system('rm models/classifier_conv_%s_*_*.h5'%(APOSTLE)) # clean checkpoints
    classifier.fit_generator(classifier_train_gen, 
                             steps_per_epoch=1000, 
                             epochs=n_epochs,
