...
#    'tau21sd' : (lambda x : div(x, 'tau2sd', 'tau1sd'), np.arange(0,1.2,0.01), r'$\tau_{21}^\mathrm{sd}$'),
    ...
    'shallow_nopt' : (lambda x : x['shallow_nopt'], np.arange(0,1.2,0.01), r'Shallow classifier'),
    'shallow_nopt_roc' : (lambda x : x['shallow_nopt'], np.arange(0,1.2,0.0001), r'Shallow classifier'),
...
#    'lstm7_10'  : (lambda x : x['trunc7_limit10_best'], np.arange(0,1.2,0.01), 'C-LSTM (7,10)'),
    ...
    'smeared_lstm4_50'  : (lambda x : x['smeared_trunc4_limit50_best'], np.arange(0,1.2,0.01), 'Smeared C-LSTM (4,50)'),
...
#    'lstm7_10_roc'  : (lambda x : x['trunc7_limit10_best'], np.arange(0,1.2,0.00001), 'C-LSTM (7,10)'),
    ...
    'smeared_lstm4_50_roc'  : (lambda x : x['smeared_trunc4_limit50_best'], np.arange(0,1.2,0.00001), 'Smeared C-LSTM (4,50)'),
...
#            'tau21sd':(r'$\tau_{21}^\mathrm{SD}$',3,':'),
            ...
            'smeared_lstm4_50_roc':('Smeared C-LSTM (4,50)',5,'--'),
