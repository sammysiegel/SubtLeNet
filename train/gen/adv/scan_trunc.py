...
f_vars = {
    ...
    'baseline_Adam_7_10_roc'  : (lambda x : x['baseline_Adam_7_10'], makebins(0,1,0.00003), '(7,10)'),
    ...
    'baseline_Adam_7_50_roc'  : (lambda x : x['baseline_Adam_7_50'], makebins(0,1,0.00003), '(7,50)'),
    ...
    'baseline_Adam_5_100'  : (lambda x : x['baseline_Adam_5_100'], makebins(0,1,0.01), '(5,100)'),
    'baseline_Adam_5_100_roc'  : (lambda x : x['baseline_Adam_5_100'], makebins(0,1,0.00003), '(5,100)'),
    'baseline_Adam_6_100'  : (lambda x : x['baseline_Adam_6_100'], makebins(0,1,0.01), '(6,100)'),
    'baseline_Adam_6_100_roc'  : (lambda x : x['baseline_Adam_6_100'], makebins(0,1,0.00003), '(6,100)'),
    'baseline_Adam_7_100'  : (lambda x : x['baseline_Adam_7_100'], makebins(0,1,0.01), '(7,100)'),
    'baseline_Adam_7_100_roc'  : (lambda x : x['baseline_Adam_7_100'], makebins(0,1,0.00003), '(7,100)'),
}
...
roc_vars = {
            ...
            'baseline_Adam_4_10_roc':('C-LSTM (4,10)',10,'-.'),
            'baseline_Adam_7_10_roc':('C-LSTM (7,10)',3,'-.'),
            'baseline_Adam_4_50_roc':('C-LSTM (4,50)',10,'--'),
            'baseline_Adam_7_50_roc':('C-LSTM (7,50)',3,'--'),
            'baseline_Adam_4_100_roc':('C-LSTM (4,100)',10),
            'baseline_Adam_5_100_roc':('C-LSTM (5,100)',11),
            'baseline_Adam_6_100_roc':('C-LSTM (6,100)',12),
            'baseline_Adam_7_100_roc':('C-LSTM (7,100)',3),
            }
...
#        'baseline_Adam_5_100_roc',
#        'baseline_Adam_6_100_roc',
