...
def setup_data(data, **kwargs):
    ...
    gen = {
        ...
        'train' : generate(data, partition='train', batch=500, **kwargs),
        'validation' : generate(data, partition='validate', batch=2000, **kwargs),
        'test' : generate(data, partition='test', batch=10, **kwargs),
        }
    return gen
...
def setup_adv_data(data, **kwargs):
    ...
    gen = {
        ...
        # 'validation' : Generator(data, partition='validate', batch=2000, **kwargs)(),
        # 'test' : Generator(data, partition='test', batch=10, **kwargs)(),
        'train' : generate(data, partition='train', batch=1000, **kwargs),
        'validation' : generate(data, partition='validate', batch=2000, **kwargs),
        'test' : generate(data, partition='test', batch=10, **kwargs),
        }
    return gen
