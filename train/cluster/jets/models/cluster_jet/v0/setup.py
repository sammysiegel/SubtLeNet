...
config.gen_default_variables = ['msd', 'tau3', 'tau2', 'tau1']
config.gen_default_mus = [149.535583, 0.060297, 0.112757, 0.265966]
config.gen_default_sigmas = [54.38921, 0.02873, 0.057523, 0.096302]
