...
# set up data 
classifier_train_gen = obj.generatePF(data, partition='train', batch=100, decorr_mass=False)
classifier_validation_gen = obj.generatePF(data, partition='validate', batch=100, decorr_mass=False)
classifier_test_gen = obj.generatePF(data, partition='validate', batch=1000, decorr_mass=False)
...
# set up data 
# train_gen = obj.generatePF(data, partition='train', batch=1000, decorr_mass=True)
